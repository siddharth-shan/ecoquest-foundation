...
const routes: Route[] = [
  ...
  { path: '/seminars/wildfire-data/', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/seminars/beach-cleanup-data/', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/seminars/home-footprint/', changeFrequency: 'monthly', priority: 0.6 },
